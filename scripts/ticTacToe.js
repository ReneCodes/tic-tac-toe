...
function checkForGameOver() {
  ...
  //Diagonal: Bottoom left to top right
  if (
    gameData[2][0] > 0 &&
...
function slectGameField(event) {
  // avoids clicking in gaps to replace Gameboard with symbol
  ...
  const winnerNumber = checkForGameOver();
